...
class AlserafiPharmacy extends StatelessWidget {
  const AlserafiPharmacy({super.key});
  static const String routeName = 'AlserafiPharmacy';
  @override
                  ...
                  children: [
                    ...
                    Center(
                      child: Container(
                        ...
                        child: Image.asset(AppAssets.AlserafiLogo),
                      ),
                    ),
                    const SizedBox(
                      height: 20,
